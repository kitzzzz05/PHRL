				...
				<div class="container-fluid">
                    ...
                    <form role="form" method="POST" action="edit_product.php<?php echo '?id='.$pid; ?>" enctype="multipart/form-data">
                        ...
                        <?php if($_SESSION['id'] == 1){ ?>
                            ...
                            <input type="text" style="width:400px;" value="<?php echo $b['price'] ?>" class="form-control" name="prodprice">
                        </div>
                      <?php }?>
                      <?php if($_SESSION['id'] <> 1){ ?>
                            <div class="form-group input-group">
                            <span class="input-group-addon" style="width:120px;">Price:</span>
                            <input type="text" style="width:400px;" value="<?php echo $b['price'] ?>" class="form-control" name="prodprice" readyonly>
                        </div>
                      <?php }?>
                      ...
                      <?php }?>
						...
						<div class="form-group input-group">
                            ...
                            <input type="text" style="width:400px;" value="<?php echo $b['product_qty'] ?>" class="form-control" name="qty" readonly>
                        </div>
						<div style="height:10px;"></div>					
						<div class="form-group input-group">
