...
$res=mysqli_query($con,"SELECT * FROM customer WHERE userid=".$usersession);
				...
				<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					<ul class="nav navbar-nav">
						<ul class="nav navbar-nav">
							...
							<!-- <li><a href="profile.php?userId=<?php echo $userRow['userid']; ?>" >Profile</a></li> -->
			...
			<div class="container">
				<div class="row">
					<div class="col-xs-12 col-md-8">
							<!-- notification end -->
							<h2 class="red-text" style="color: white;">Hi, <?php echo $userRow['customer_name']; ?>. Make appointment today!</h2>
