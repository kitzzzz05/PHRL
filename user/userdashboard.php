...
$res=mysql_query("SELECT * FROM user WHERE icuser=".$usersession);
        ...
        <div id="wrapper">
            ...
            <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="userdashboard.html">user Dashboard</a>
                </div>
                <!-- Top Menu Items -->
                ...
                <div class="collapse navbar-collapse navbar-ex1-collapse">
                    <ul class="nav navbar-nav side-nav">
                        ...
                        <li>
                            <a href="userprofile.php?userEmail=<?php echo $userRow['userEmail']; ?>"><i class="fa fa-fw fa-bar-chart-o"></i> Profile</a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a href="userdashboard-rtl.html"><i class="fa fa-fw fa-dashboard"></i> RTL Dashboard</a>
                        </li>
                    </ul>
                </div>
                <!-- /.navbar-collapse -->
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-body">
                                ...
                                <!-- table to display admin schedule start -->
                                <div id="txtHint"><b> admin schedule will be list here</b></div>
                                <!-- table to display admin schedule end -->
